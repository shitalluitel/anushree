"""
Django settings for anushree project.
...
SECRET_KEY = env('DJANGO_SECRET_KEY', default='irja(j*j%uea(%_y_3ylb9cr#%94wq=x&wczjkl08(z2ncuc1+')
...
WSGI_APPLICATION = 'anushree.wsgi.application'
